...
PROJECT_NAME := provider-github-example
PROJECT_REPO := github.com/DavidBajus/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 5.14.0
...
xpkg.build.provider-github-example: do.build.images
